...
D01 uses a compliant tokenisation standard ([CMTAT](https://cmta.ch/standards/cmta-token-cmtat)) to model Shares, Options, SAFEs and other instruments, with a proprietary Compliance Layer that codifies and enforces the laws of each jurisdiction.

[ZAMA](https://www.zama.org) is used for onchain privacy, and confidentiality.
...
**Regulatory Clarity**
[SEC clarified](https://www.sec.gov/newsroom/speeches-statements/corp-fin-statement-tokenized-securities-012826-statement-tokenized-securities) that equity tokens integrated into official registers represent true equity ownership. Swiss and Delaware law already support blockchain ledgers. [EU-INC](https://www.eu-inc.org) in the works.

**Scaling & Privacy**
New protocols solved blockchain privacy ([FHE](https://en.wikipedia.org/wiki/Homomorphic_encryption#Characteristics)), allowing confidentiality without sacrificing compliance. Transaction costs are close to negligible.
...
$210B+ in private secondary volume, growing 30-50% YoY, heading to $400B by 2030. The demand for private securities infrastructure is accelerating ***independently*** of crypto.
...
[d01.io](https://d01.io) · [@equitylayer](https://x.com/equitylayer) · [Contact](mailto:petros@d01.io)
